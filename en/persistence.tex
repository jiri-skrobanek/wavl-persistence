...
When we enter a fat vertex, we lock it for other threads of computation. Conversely, lock is lifted when the fat vertex is left. Since all threads begin locking at the root and descend towards the leaves, no deadlocking is possible. %TODO: This is wrong!
...
%TODO: Delete: 1. lock larger part, 2. Ghost vertices

...
Some of the techniques which we will use will be nearly identical to those of Driscoll at al.
...
When a new version of the tree should by created by delete or insert, new copies are allocated only for vertices that are changed by the operation, and for their ancestors. 
